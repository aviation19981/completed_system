...
if ($row["booked"] == 1) {
	...
	/////////////
                	echo $total . '</td><td>';
						...
						echo '<a href="./index_user.php?page=plane_info_public&registry_id=' . $row["registry"] . '"><span class="flaticon-flight icon icon--sm"></span></a></td></tr>';
					}
