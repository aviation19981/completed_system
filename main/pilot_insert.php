...
window.location = './index.php?page=registromiembros';
</script>
...
<?php
			...
			if ($pass==$password2)  {
				...
				$sql1 = "insert into gvausers (facebook,register_date,activation,name,surname,callsign,email,password,ivaovid,hub_id,country,city,reg_comments,birth_date,language,accept_emails, operator_id)
                    values ('$facebook',now(),0,'$name','$surname','_NEW_','$emails','$encryptpassword','$ivao','$hub_id','$country','$city','$notes','$birthday','$language','$accept_emails','$ope');";
