	...
	$coment = $_POST['coment'];
		...
		if ($db->connect_errno > 0) {
			die('Unable to connect to database [' . $db->connect_error . ']');
				...
				$sql1 = "insert into citacion (piloto,docente,fecha,hora,comentarios)
                    values ('$estudiantes','$docentes','$date','$hour','$coment');";
			...
			$sql2 = "SELECT * FROM gvausers where  gvauser_id='" . $estudiantes . "'";
...
$baseuri = "http://".$_SERVER['SERVER_NAME'].implode("/",$baseuri);	
			...
			$para      = $emails;
$titulo    = 'ColStar VA System - CITACIÓN';
        ...
        <td align="center">
          <table border="0" cellspacing="0" cellpadding="0" width="600" align="center" bgcolor="#ffffff">
            <tbody>
              ...
              <tr>
                <td style="font-family:Arial, Helvetica, sans-serif; font-size:40px; color:#374959;" align="center">Citación<br>
              ...
              <tr>
                <td style="font-family:Arial, Helvetica, sans-serif; font-size:25px; color:#374959; padding:35px 75px 35px 75px;" align="left">
                  ...
                  A continuación encontrará la información de su <a href="#" style="color:#0078d2; text-decoration:none;" target="_blank" title="cuenta">citación</a> con uno de los instructores o staff de ColStar Alliance.
                  <br><br> Fecha de Citación a Training: <b>' .$date . '</b>.
                  <br><br> Horario de Training: <b>' .$hour . '</b>.
				  <br><br> Comentarios del docente: <b>' .$coment . '</b>.
                  </span>
                </td>
              </tr>
              <!--CTA Button-->
...
<script>
alert('Citación agregada, sactisfactoriamente.');
