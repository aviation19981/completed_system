...
$latitude_deg_arr * $degtorad) * cos($dlong * $degtorad)); 
    ...
    $kms = round(($dd * $km), 2);
     ...
     $leg_length = round($kms*$nms);
			...
			$sql1 = "update tour_legs set departure='$departure', arrival='$arrival', route='$route', leg_length='$leg_length'
			where tour_leg_id='$tour_leg_id'";
...
alert('Leg Tour actualizada satisfactoriamente.');
window.location = './?page=updatetourlegva&tour=<?php echo $tour_leg_id; ?>';
